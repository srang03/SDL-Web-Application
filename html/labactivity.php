...
if(isset($_REQUEST["page"])) // $_REQUEST["page"]값이 없을 때에는 1로 지정 
  ...
  if($mode=="search"){
    ...
    $sql="select * from chna03.labactivity where $find like '%$search%' order by num desc";
  } else {
    $sql="select * from chna03.labactivity order by num desc, ord asc limit $first_num, $scale";
    //limit를 사용해 레코드 개수를 한 페이지당 출력하는 수로 제한
  }
  try{  
    $stmh = $pdo->query($sql); 

$sql = "select * from chna03.labactivity";  //전체 레코드수를 파악하기 위함.
$stmh1 = $pdo->query($sql);
...
<body>
  ...
  <div id = "wrap">
    ...
    <div id="header_media">
      ...
      <ul id="nav_media">
        ...
        <li><a href="labactivity.php">연구실 활동</a></li>
   ...
   <section class="notice_section">
    ...
    <div class="page_contents">
      ...
      <form name="board_form" method="post" action="labactivity.php?mode=search">
        <div id="list_search">
  ...
  while($row = $stmh->fetch(PDO::FETCH_ASSOC)) {
    ...
    <div id="list_item">
      ...
      <div id="list_item2"><?=$space?><a href="labactivity_view.php?num=<?=$item_num?>&page=<?=$page?>"><?= $item_subject ?></a></div>
  ...
  <div id="page_num">
    ...
    if($page!=1 && $page>$page_scale)
    {
      ...
      if($prev_page <= 0) 
          ...
          print "<a href=labactivity.php?page=$prev_page>◀ </a>";
        }
      ...
      {        // [1][2][3] 페이지 번호 목록 출력
        ...
        print "<font color=red><b>[$i]</b></font>"; 
         ...
         print "<a href=labactivity.php?page=$i>[$i]</a>";
     }
     ...
     if($page<$total_page)
     {
      ...
      print "<a href=labactivity.php?page=$next_page> ▶</a><p>";
    }
    ?>      
  </div>
</div>
...
<div id="write_button">
  <a href="labactivity"><img src="./img/list.png"></a>&nbsp;
  <?php
  if(isset($_SESSION["userid"]))
  {
    ?>
    <a href="labactivity_write_form"><img src="./img/write.png"></a>
    <?php
  }
  ?>
</div>
