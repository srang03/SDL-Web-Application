 ...
 try{
  ...
  try{
   $pdo->beginTransaction(); 
       $sql = "update chna03.labactivity set hit=? where num=?";   // 조회수 증가
       $stmh = $pdo->prepare($sql);  
     ...
     <div id="view_button">
      ...
      if(isset($_SESSION["userid"])) {
        if($_SESSION["userid"]==$item_id || $_SESSION["userid"]=="admin"){
         ?>
         <a href="labactivity_write_form.php?mode=modify&num=<?=$num?>&page=<?=$page?>"><img src="./img/modify.png"></a>&nbsp;

         <a href="javascript:del('labactivity_delete.php?num=<?=$num?>')"><img src="./img/delete.png"></a>&nbsp;
       <?php    }
       ?>
