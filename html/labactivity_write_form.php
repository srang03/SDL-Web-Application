...
$page=$_REQUEST["page"];
 ...
 if ($mode=="modify" || $mode=="response"){
   ...
   try{
    ...
    $sql = "select * from chna03.labactivity where num = ? ";
...
<body>
  <div id="wrap">
    ...
    <?php include "./lib/nav_media2.php"; ?> <!-- 메뉴바, 드롭다운 -->
    ...
    <section>
      ...
      <div class="page_contents">
        ...
        <div id="col2">
          ...
          if($mode=="modify"){ 
            ?>
            <form name="board_form" method="post" action="labactivity_insert.php?mode=modify&num=<?=$num?>&page=<?=$page?>" enctype="multipart/form-data"> 
            <?php  } elseif ($mode=="response") {
              ?>
              <form  name="board_form" method="post" action="labactivity_insert.php?mode=response$num=<?=$num?>&page=<?=$page?>" enctype="multipart/form-data"> 
                <?php
              } else {
                ?>
                <form  name="board_form" method="post" action="labactivity_insert.php"> 
                 <?php
               }
               ?>
               <div id="write_form">
                 ...
                 <div id="write_row2">
                  ...
                  <div id="write_button"><input type="image" src="./img/ok.png">
                    <a href="labactivity.php"><img src="./img/list.png"></a>
                  </div>
                </form>
